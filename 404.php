...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>404 | Virtual Care Solutions VCS</title>
...
<link href="assets/dashboard/assets/css/icons.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class="loading authentication-bg authentication-bg-pattern">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mb-0">It's looking like you may have taken a wrong turn. Or you are not allowed. You might want to check your internet connection.
        ...
        <footer class="footer footer-alt">
            <a href="" class="text-white-50"><script>document.write(new Date().getFullYear())</script> &copy;  PQW - IT Managment consulting - Germany for YAS Clinic Group</a> 
        </footer>
