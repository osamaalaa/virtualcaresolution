    ...
    $("#selection-datatable").DataTable({
        ...
        $("#row-callback-datatable")
            .DataTable({
                ...
                }, drawCallback: function () { $(".dataTables_paginate > .pagination").addClass("pagination-rounded") }, createdRow: function (a, e, t) { 15e4 < 1 * e[5].replace(/[\$,]/g, "") && $("td", a).eq(5).addClass("text-danger") }
