    ...
    a.prototype.createBarChart=function(a,t,e,o,r,i){
        ...
        a.prototype.createAreaChartDotted=function(a,t,e,o,r,i,s,l,n,c){
            ...
            a.prototype.createDonutChart=function(a,t,e){  
                ...
                a.prototype.init=function(){var a=["#02c0ce"];(t=e("#statistics-chart").data("colors"))
                &&(a=t.split(",")),
                this.createBarChart("statistics-chart",[{y:"2017",a:87},{y:"2018",a:75},{y:"2019",a:50},{y:"2020",a:75},{y:"2021",a:50},{y:"2022",a:38}],"y",["a"],["Statistics"],a);a=["#4a81d4","#e3eaef"];
                (t=e("#income-amounts").data("colors"))&&(a=t.split(",")),
                this.createAreaChartDotted("income-amounts",0,0,[{y:"2012",a:10,b:20},{y:"2013",a:75,b:65},{y:"2014",a:50,b:40},{y:"2015",a:75,b:65},{y:"2016",a:50,b:40},{y:"2017",a:75,b:65},{y:"2018",a:90,b:60}],"y",["a","b"],["Bitcoin","Litecoin"],["#ffffff"],["#999999"],a);var t;a=["#4fc6e1","#6658dd","#ebeff2"];
                (t=e("#lifetime-sales").data("colors"))&&(a=t.split(",")),
                
                this.createDonutChart("lifetime-sales",
                [{label:" Total Users ", 
                    value: e("#lifetime-sales").data("users")
                },
                {label:" Doctors",
                value:e("#lifetime-sales").data("doctors")
                },
                {label:"Patients",
                value:e("#lifetime-sales").data("patients")
                }
                ],a)},
                e.Dashboard4=new a,e.Dashboard4.Constructor=a}(window.jQuery),
                function(a){
