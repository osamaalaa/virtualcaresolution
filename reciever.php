...
if (isset($_GET['token']) && isset($_GET['uid']) && isset($_GET['channel'])) {
    if ($servant->validateRequest($_SESSION['user_id'])) {
...
?>
        ...
        <head>
            ...
            <!--====== Fontawesome css ======-->
            <link rel="stylesheet" href="./assets/vcs-old/css/font-awesome.min.css">

            <!--====== Magnific Popup css ======-->
            <link rel="stylesheet" href="./assets/vcs-old/css/magnific-popup.css">

            <!--====== Slick css ======-->
            <link rel="stylesheet" href="./assets/vcs-old/css/slick.css">

            <!--====== Default css ======-->
            <link rel="stylesheet" href="./assets/vcs-old/css/default.css">
    ...
    <header id="home" class="header-area header-v1-area">
        ...
        <section class="hero-area bg_cover" style="background-image: url(assets/vcs-old/images/hero-bg.jpg); overflow: auto;">
            <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
            ...
            <script>
                ...
                $(function() {
                    ...
                    $("#join").on("click", function(e) {
                        ...
                        /*  var params = {
                             "appID": "59d107639dca474c9ac93fc22d9301",
                             "channel": "TEST",
                             "token": "00659d107639dca474c9ac93fc22d9301c3IADSoX41+J1xKXQWG6wiAG6FgUsrI7NIMy1TcLiqmg4u7riT6u70NTV7IgDNDAEAiN3hXwQAAQAYmuBfAwAYmuBfAgAYmuBfBAAYmuBf",
                             "uid": "2882341274",
                             "cameraId": "",
                             "mode": "live",
                             "microphoneId": "",
